if(sessionStorage.getItem('id') == null){
    ...
    function pintarPagina(){
        ...
        $.ajax({
            url:   'https://adminkiosko.azurewebsites.net/api/alumnos',
            type:  'post',
            beforeSend: function () {
    ...
    function registrar(){
        ...
        $.ajax({
            ...
            data:  datos,
            dataType: "json",
            url:   'https://adminkiosko.azurewebsites.net/api/setalumnos',
            type:  'post',
            beforeSend: function () {
    ...
    function eliminar(){
        $.ajax({
            url:   'https://adminkiosko.azurewebsites.net/api/delalumnos/'+document.getElementById('matriculaAlumno').value,
            type:  'delete',
            beforeSend: function () {
                    $("#boton").html("Procesando, espere por favor...");
            },
