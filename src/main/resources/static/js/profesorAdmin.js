if (sessionStorage.getItem('id') == null) {
    location.href = "https://adminkiosko.azurewebsites.net/loginAdmin.html";
} else {
    ...
    function pintarPagina() {
        ...
        $.ajax({
            url: 'https://adminkiosko.azurewebsites.net/api/profesores',
            type: 'post',
            beforeSend: function () {
    ...
    function registrar() {
        ...
        $.ajax({
            ...
            data: datos,
            dataType: "json",
            url: 'https://adminkiosko.azurewebsites.net/api/setprofesores',
            type: 'post',
            beforeSend: function () {
    ...
    function eliminar() {
        $.ajax({
            url: 'https://adminkiosko.azurewebsites.net/api/deprofesores/' + document.getElementById('idProfesor').value,
            type: 'delete',
            beforeSend: function () {
                $("#boton").html("Procesando, espere por favor...");
            },
    ...
    function pintargrupo() {
        document.getElementById('tabla').innerHTML = ""
        $.ajax({
            url: 'https://adminkiosko.azurewebsites.net/api/grupo',
            type: 'post',
            beforeSend: function () {
                $("#boton").html("Procesando, espere por favor...");
            },
    ...
    function pintarmateria() {
        ...
        $.ajax({
            url: 'https://adminkiosko.azurewebsites.net/api/materia',
            type: 'post',
            beforeSend: function () {
                $("#boton").html("Procesando, espere por favor...");
            },
    ...
    function materiaGrupo(){
        ...
        $.ajax({
            ...
            data: datos,
            dataType: "json",
            url: 'https://adminkiosko.azurewebsites.net/api/Profe/Grupo/Materia',
            type: 'post',
            beforeSend: function () {
                $("#resultado").html("Procesando, espere por favor...");
            },
