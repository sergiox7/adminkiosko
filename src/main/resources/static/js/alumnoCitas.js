...
if(sessionStorage.getItem('id') == null){
    location.href ="https://adminkiosko.azurewebsites.net/login.html";
}else{
...
$.ajax({
  url:   'https://adminkiosko.azurewebsites.net/api/optenerProfesor',
  type:  'post',
  beforeSend: function () {
...
function guardarkiosko(idProfesor){
    ...
    location.href ="https://adminkiosko.azurewebsites.net/alumnoKiosko.html";
}
...
function agendarCita(){
  ...
  $.ajax({
      ...
      data:  datoscita,
      dataType: "json",
      url:   'https://adminkiosko.azurewebsites.net/api/insertarCita',
      type:  'post',
      beforeSend: function () {
      ...
      success:  function (response) {
          $("#resultado").html("Notificaciones");
          location.href ="https://adminkiosko.azurewebsites.net/alumnoCitasAgendadas.html";
